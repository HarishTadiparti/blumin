...
const Industry = () => {
  ...
  return (
    <>
      <section className="text-gray-600 body-font pt-4 pb-16">
        <div className="container px-5 mx-auto">
          <h1 className="text-6xl font-bold title-font text-gray-900 text-center">
            Industry
          </h1>
        </div>
      </section>
      <div className="container mx-auto px-5 py-4 bg-white rounded-2xl">
